    ...
    if (password.value === passwordVerify.value) {
      AuthApiService.postUser(newUser)
        ...
        .catch((res) => {
          ...
          this.context.updateErrorMessage("Oops: " + res.error?.message);
      ...
      <form id="register-form" onSubmit={this.handleRegSubmit}>
        ...
        <div>
          ...
          <select id="marital_status" required>
            <option value="Single" name="marital_status">
              Single
            </option>
            <option value="Married" name="marital_status">
              Married
            </option>
            <option value="Divorced" name="marital_status">
              Divorced
            </option>
            <option value="Separated" name="marital_status">
              Separated
            </option>
          </select>
        </div>
        ...
        <div>
          ...
          <input
            ...
            id="email"
            name="email"
            placeholder="ex. myemailaddress@email.com"
            required
          />
        </div>
        <div>
          <div>
            <p className="info info-password">
              Your password must contain 1 number, 1 capital letter, 1 special
              character (!@#$%^&amp;) and it must be at least 8 characters long.
            </p>
          </div>
        ...
        <div className="loading-message">
          {!!this.context.loadingMessage && this.context.loadingMessage}
        </div>
        <div>
